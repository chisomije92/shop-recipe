...
class AppComponent {
    constructor(authService, store, platformId) {
...
AppComponent.ɵfac = function AppComponent_Factory(t) { return new (t || AppComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_auth_auth_service__WEBPACK_IMPORTED_MODULE_1__.AuthService), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_ngrx_store__WEBPACK_IMPORTED_MODULE_5__.Store), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_4__.PLATFORM_ID)); };
AppComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 5, vars: 0, consts: [[1, "container"], [1, "row"], [1, "col-md-12"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, dependencies: [_angular_router__WEBPACK_IMPORTED_MODULE_6__.RouterOutlet, _header_header_component__WEBPACK_IMPORTED_MODULE_2__.HeaderComponent], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAuY29tcG9uZW50LmNzcyJ9 */"] });
...
class AuthComponent {
    ...
    onSubmit() {
        ...
        if (this.isLoginMode) {
            this.isLoading = true;
            this.store.dispatch(new _store_auth_actions__WEBPACK_IMPORTED_MODULE_0__.LoginStart({ email, password }));
        }
        else {
            this.isLoading = true;
            this.store.dispatch(new _store_auth_actions__WEBPACK_IMPORTED_MODULE_0__.SignupStart({ email, password }));
        }
        this.authForm.reset();
    }
    onHandleError() {
        this.store.dispatch(new _store_auth_actions__WEBPACK_IMPORTED_MODULE_0__.ClearError());
    }
    initForm() {
...
class AuthGuard {
    ...
    canActivate(route, state) {
        return this.store.select('auth').pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_1__.take)(1), (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.map)((authState) => authState.user), (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.map)((user) => {
            const isAuth = !!user;
            if (isAuth) {
                return true;
            }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AUTHENTICATION_FAIL": () => (/* binding */ AUTHENTICATION_FAIL),
/* harmony export */   "AUTHENTICATION_SUCCESS": () => (/* binding */ AUTHENTICATION_SUCCESS),
...
/* harmony export */ });
const AUTHENTICATION_SUCCESS = '[Auth] Login';
const LOGOUT = '[Auth] Logout';
const LOGIN_START = '[Auth] Login Start';
const AUTHENTICATION_FAIL = '[Auth] Login fail';
...
class AuthenticationSuccess {
    constructor(payload) {
        ...
        this.type = AUTHENTICATION_SUCCESS;
    }
}
class Logout {
    constructor() {
...
const handleAuthentication = (resData) => {
    ...
    return new _auth_actions__WEBPACK_IMPORTED_MODULE_1__.AuthenticationSuccess({
        email: resData.email,
...
const handleError = (errorRes) => {
    ...
    if (!errorRes.error || !errorRes.error.error) {
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.of)(new _auth_actions__WEBPACK_IMPORTED_MODULE_1__.AuthenticationFail(errorMsg));
    }
...
class AuthEffects {
    constructor(actions$, http, router, authService) {
        ...
        this.authSignUp$ = (0,_ngrx_effects__WEBPACK_IMPORTED_MODULE_5__.createEffect)(() => {
            return this.actions$.pipe((0,_ngrx_effects__WEBPACK_IMPORTED_MODULE_5__.ofType)(_auth_actions__WEBPACK_IMPORTED_MODULE_1__.SIGNUP_START), (0,rxjs__WEBPACK_IMPORTED_MODULE_6__.switchMap)((signupAction) => {
                return this.http
        ...
        this.authLogin$ = (0,_ngrx_effects__WEBPACK_IMPORTED_MODULE_5__.createEffect)(() => {
            return this.actions$.pipe((0,_ngrx_effects__WEBPACK_IMPORTED_MODULE_5__.ofType)(_auth_actions__WEBPACK_IMPORTED_MODULE_1__.LOGIN_START), (0,rxjs__WEBPACK_IMPORTED_MODULE_6__.switchMap)((authData) => {
                return this.http
        ...
        this.authRedirect$ = (0,_ngrx_effects__WEBPACK_IMPORTED_MODULE_5__.createEffect)(() => {
            return this.actions$.pipe((0,_ngrx_effects__WEBPACK_IMPORTED_MODULE_5__.ofType)(_auth_actions__WEBPACK_IMPORTED_MODULE_1__.AUTHENTICATION_SUCCESS), (0,rxjs__WEBPACK_IMPORTED_MODULE_7__.tap)((authSuccessAction) => {
        ...
        this.autoLogin$ = (0,_ngrx_effects__WEBPACK_IMPORTED_MODULE_5__.createEffect)(() => {
            return this.actions$.pipe((0,_ngrx_effects__WEBPACK_IMPORTED_MODULE_5__.ofType)(_auth_actions__WEBPACK_IMPORTED_MODULE_1__.AUTO_LOGIN), (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.map)(() => {
...
function authReducer(state = initialState, action) {
    switch (action.type) {
        case _auth_actions__WEBPACK_IMPORTED_MODULE_1__.AUTHENTICATION_SUCCESS:
        ...
        case _auth_actions__WEBPACK_IMPORTED_MODULE_1__.AUTHENTICATION_FAIL:
            return {
                ...state,
                user: null,
...
function HeaderComponent_li_8_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "li", 8)(1, "a", 14);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtext"](2, "Recipe");
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]()();
} if (rf & 2) {
...
function HeaderComponent_li_9_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "li", 8)(1, "a", 14);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtext"](2, "Authentication");
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]()();
} if (rf & 2) {
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](1);
...
function HeaderComponent_a_15_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function HeaderComponent_a_15_Template_a_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵrestoreView"](_r5); const ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵnextContext"](); return _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵresetView"](ctx_r4.onLogout()); });
...
function HeaderComponent_li_16_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "li", 16)(1, "a", 17);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtext"](2, " Manage ");
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](3, "ul", 18)(4, "li", 19)(5, "a", 20);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function HeaderComponent_li_16_Template_a_click_5_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵrestoreView"](_r7); const ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵnextContext"](); return _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵresetView"](ctx_r6.onSaveData()); });
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtext"](6, "Save Data");
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]()();
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](7, "li")(8, "a", 20);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function HeaderComponent_li_16_Template_a_click_8_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵrestoreView"](_r7); const ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵnextContext"](); return _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵresetView"](ctx_r8.onFetchData()); });
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtext"](9, "Fetch Data");
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]()()()();
} }
class HeaderComponent {
    ...
    ngOnInit() {
        this.userSub = this.store
            .select('auth')
            .pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_5__.map)((authState) => authState.user))
            .subscribe((user) => {
            this.isAuth = !!user;
        });
    }
    onSaveData() {
        ...
        this.store.dispatch(new _recipe_store_recipe_action__WEBPACK_IMPORTED_MODULE_1__.StoreRecipes());
    }
    onFetchData() {
        //this.dataStorageService.fetchRecipes().subscribe();
        this.store.dispatch(new _recipe_store_recipe_action__WEBPACK_IMPORTED_MODULE_1__.FetchRecipes());
    }
    onLogout() {
...
HeaderComponent.ɵfac = function HeaderComponent_Factory(t) { return new (t || HeaderComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_shared_data_storage_service__WEBPACK_IMPORTED_MODULE_2__.DataStorageService), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_auth_auth_service__WEBPACK_IMPORTED_MODULE_3__.AuthService), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_ngrx_store__WEBPACK_IMPORTED_MODULE_6__.Store)); };
HeaderComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({ type: HeaderComponent, selectors: [["app-header"]], decls: 17, vars: 4, consts: [[1, "navbar", "navbar-expand-lg", "navbar-light", "bg-light"], [1, "container-fluid"], [1, "navbar-brand", "mb-0", "h1", 2, "cursor", "pointer"], ["type", "button", "data-bs-toggle", "collapse", "data-bs-target", "#navbarSupportedContent", "aria-controls", "navbarSupportedContent", "aria-expanded", "false", "aria-label", "Toggle navigation", 1, "navbar-toggler"], [1, "navbar-toggler-icon"], ["id", "navbarSupportedContent", 1, "collapse", "navbar-collapse"], [1, "navbar-nav", "me-auto", "mb-2", "mb-lg-0", "me-auto", "mb-2", "mb-lg-0"], ["class", "nav-item", "routerLinkActive", "active", 4, "ngIf"], ["routerLinkActive", "active", 1, "nav-item"], ["routerLink", "/shopping-list", 1, "nav-link"], [1, "nav", "navbar-nav", "navbar-right"], [1, "nav-item"], ["class", "nav-link", "style", "cursor: pointer", 3, "click", 4, "ngIf"], ["class", "dropdown", 4, "ngIf"], [1, "nav-link", 3, "routerLink"], [1, "nav-link", 2, "cursor", "pointer", 3, "click"], [1, "dropdown"], ["id", "navbarDropdown", "role", "button", "data-bs-toggle", "dropdown", "aria-expanded", "false", 1, "nav-link", "dropdown-toggle", 2, "cursor", "pointer"], ["aria-labelledby", "navbarDropdown ", 1, "dropdown-menu", "w-50", "p-2"], [1, "border-bottom"], [1, "dropdown-item", "nav-link", 2, "cursor", "pointer", 3, "click"]], template: function HeaderComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtext"](3, "Recipe Book");
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](6, "div", 5)(7, "ul", 6);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtemplate"](8, HeaderComponent_li_8_Template, 3, 2, "li", 7);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtemplate"](9, HeaderComponent_li_9_Template, 3, 2, "li", 7);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](10, "li", 8)(11, "a", 9);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtext"](12, "Shopping List");
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]()()();
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](13, "ul", 10)(14, "li", 11);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtemplate"](15, HeaderComponent_a_15_Template, 2, 0, "a", 12);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtemplate"](16, HeaderComponent_li_16_Template, 10, 0, "li", 13);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]()()()();
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](8);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵproperty"]("ngIf", ctx.isAuth);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵproperty"]("ngIf", !ctx.isAuth);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵproperty"]("ngIf", ctx.isAuth);
    } }, dependencies: [_angular_common__WEBPACK_IMPORTED_MODULE_7__.NgIf, _angular_router__WEBPACK_IMPORTED_MODULE_8__.RouterLinkWithHref, _angular_router__WEBPACK_IMPORTED_MODULE_8__.RouterLinkActive], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJoZWFkZXIuY29tcG9uZW50LmNzcyJ9 */"] });
...
class RecipeDetailComponent {
    ...
    ngOnInit() {
        ...
        this.route.params
            ...
            (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.map)((recipeState) => recipeState.recipes.find((recipe, index) => index === this.id)), (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.tap)((recipe) => {
                if (!recipe) {
                    this.router.navigate(['recipes']);
                }
            }))
    ...
    onAddToShoppingList() {
        ...
        //}
        if (this.recipe) {
            this.store.dispatch(new _shopping_list_store_shopping_list_action__WEBPACK_IMPORTED_MODULE_1__.AddIngredients(this.recipe.ingredients));
        }
    }
    onAddRecipe() {
    ...
    onDeleteRecipe() {
        ...
        this.store.dispatch(new _store_recipe_action__WEBPACK_IMPORTED_MODULE_0__.DeleteRecipe(this.id));
        this.router.navigate(['/recipes']);
    }
}
...
class RecipeEditComponent {
    ...
    onSubmit() {
        if (this.editMode) {
            ...
            this.store.dispatch(new _store_recipe_action__WEBPACK_IMPORTED_MODULE_0__.UpdateRecipe({
                index: this.id,
            ...
            this.store.dispatch(new _store_recipe_action__WEBPACK_IMPORTED_MODULE_0__.AddRecipe(this.recipeForm.value));
        }
        this.onCancel();
    }
    onAddIngredient() {
...
class RecipeResolverService {
    ...
    resolve(route, state) {
        return this.store.select('recipes').pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_1__.take)(1), (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.map)((recipeState) => {
            ...
            if (recipes.length === 0) {
                this.store.dispatch(new _store_recipe_action__WEBPACK_IMPORTED_MODULE_0__.FetchRecipes());
                return this.action$.pipe((0,_ngrx_effects__WEBPACK_IMPORTED_MODULE_4__.ofType)(_store_recipe_action__WEBPACK_IMPORTED_MODULE_0__.SET_RECIPES), (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.take)(1));
            }
            else {
...
class RecipeService {
    ...
    getRecipe() {
        ...
        this.store.dispatch(new _store_recipe_action__WEBPACK_IMPORTED_MODULE_1__.FetchRecipes());
    }
    addIngredientsToShoppingList(ingredients) {
        // this.slService.addIngredients(ingredients);
        this.store.dispatch(new _shopping_list_store_shopping_list_action__WEBPACK_IMPORTED_MODULE_0__.AddIngredients(ingredients));
    }
    getRecipeById(index) {
...
class RecipeEffects {
    constructor(action$, http, store) {
        ...
        this.storeRecipe$ = (0,_ngrx_effects__WEBPACK_IMPORTED_MODULE_1__.createEffect)(() => {
            return this.action$.pipe((0,_ngrx_effects__WEBPACK_IMPORTED_MODULE_1__.ofType)(_recipe_action__WEBPACK_IMPORTED_MODULE_0__.STORE_RECIPES), (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.withLatestFrom)(this.store.select('recipes')), (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.switchMap)(([actionData, recipeState]) => {
        ...
        this.fetchRecipes$ = (0,_ngrx_effects__WEBPACK_IMPORTED_MODULE_1__.createEffect)(() => {
            return this.action$.pipe((0,_ngrx_effects__WEBPACK_IMPORTED_MODULE_1__.ofType)(_recipe_action__WEBPACK_IMPORTED_MODULE_0__.FETCH_RECIPES), (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.switchMap)(() => {
                ...
                return new _recipe_action__WEBPACK_IMPORTED_MODULE_0__.SetRecipes(recipes);
            }));
        });
    }
}
...
function recipeReducer(state = initialState, action) {
    switch (action.type) {
        case _recipe_action__WEBPACK_IMPORTED_MODULE_0__.SET_RECIPES:
            return {
                ...state,
                recipes: [...action.payload],
            };
        case _recipe_action__WEBPACK_IMPORTED_MODULE_0__.ADD_RECIPE:
            return {
                ...state,
                recipes: [...state.recipes, action.payload],
            };
        case _recipe_action__WEBPACK_IMPORTED_MODULE_0__.UPDATE_RECIPE:
            const updatedRecipe = {
        ...
        case _recipe_action__WEBPACK_IMPORTED_MODULE_0__.DELETE_RECIPE:
            return {
                ...state,
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ 635);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs */ 9337);
/* harmony import */ var _recipe_store_recipe_action__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../recipe/store/recipe.action */ 5260);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/core */ 2560);
...
class DataStorageService {
    ...
    storeRecipe() {
        ...
        return this.http.put('https://ng-shop-recipe-90217-default-rtdb.firebaseio.com/recipes.json', recipes);
    }
    fetchRecipes() {
        return this.http
            .get('https://ng-shop-recipe-90217-default-rtdb.firebaseio.com/recipes.json')
            ...
            this.store.dispatch(new _recipe_store_recipe_action__WEBPACK_IMPORTED_MODULE_0__.SetRecipes(recipes));
        }));
    }
}
DataStorageService.ɵfac = function DataStorageService_Factory(t) { return new (t || DataStorageService)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_5__.HttpClient), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_recipe_recipe_service__WEBPACK_IMPORTED_MODULE_1__.RecipeService), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_ngrx_store__WEBPACK_IMPORTED_MODULE_6__.Store)); };
...
class ShoppingEditComponent {
    ...
    onSubmit(form) {
        ...
        if (this.editMode) {
            this.store.dispatch(new _store_shopping_list_action__WEBPACK_IMPORTED_MODULE_1__.UpdateIngredients(newIngredient));
        }
        else {
    ...
    onDelete() {
        this.store.dispatch(new _store_shopping_list_action__WEBPACK_IMPORTED_MODULE_1__.DeleteIngredients());
        this.onClear();
    }
    ngOnDestroy() {
        this.subscription?.unsubscribe();
...
/* harmony export */   "UpdateIngredients": () => (/* binding */ UpdateIngredients)
/* harmony export */ });
const ADD_INGREDIENT = '[Shopping List] Add Ingredient';
const ADD_INGREDIENTS = '[Shopping List] Add ingredients';
const DELETE_INGREDIENTS = '[Shopping List] Delete Ingredients';
const UPDATE_INGREDIENTS = '[Shopping List] Update Ingredients';
...
function shoppingListReducer(state = initialState, action) {
    switch (action.type) {
        ...
        case _shopping_list_action__WEBPACK_IMPORTED_MODULE_1__.DELETE_INGREDIENTS:
            return {
                ...state,
        ...
        case _shopping_list_action__WEBPACK_IMPORTED_MODULE_1__.UPDATE_INGREDIENTS:
